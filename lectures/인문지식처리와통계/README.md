...
- **피벗(pivot)**
  ...
  - 요약에는 합계, 평균, 기타 통계가 포함될 수 있으며 피벗 테이블이 이들을 의미 있는 방식으로 함께 묶어 준다.
    - `실습) 동사로 필터링한 피벗 테이블`  
      ![image](https://user-images.githubusercontent.com/61646760/159442652-3c6e96f1-4ab3-4d6d-ac1c-10051317fd09.png)
...
### 과제 제출
- [X] 01, 02 파일 문장을 바꿔서 실행해 보고 공유 및 업로드
- [ ] 역대 대통령 취임사 데이터를 내 마음대로 분석해 보고 xlsx 파일 업로드 (해석과 발표)
